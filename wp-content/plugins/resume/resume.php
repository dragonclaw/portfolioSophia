 ...
 *
 * @wordpress-plugin
 * Plugin Name: Resume Post Type
 * Plugin URI:  http://thimpress.com
 * Description: Enables a resume post type, taxonomy and metaboxes.
 * Version:     0.1.0
 * Author:      Albert
 * Author URI:  http://thimpress.com
 * Text Domain: resume-post-type
 * License:     GPL-2.0+
...
$post_type_registrations = new Resume_Post_Type_Registrations;

// Instantiate main plugin file, so activation callback does not need to be static.
$post_type = new Resume_Post_Type( $post_type_registrations );
...
$post_type_metaboxes = new Resume_Post_Type_Metaboxes;
...
if ( is_admin() ) {
	...
	$post_type_admin = new Resume_Post_Type_Admin( $post_type_registrations );
